                        ...
                        <td className="px-6 py-4 text-right">
                          {simulation.status === 'REQUESTED' || simulation.status === 'RUNNING' ? (
                            <button
                              ...
                              className="h-8 w-[73px] whitespace-nowrap rounded-lg border border-danger/25 px-3 text-xs font-bold text-danger-strong transition hover:bg-danger-soft focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring disabled:cursor-not-allowed disabled:opacity-50"
                            >

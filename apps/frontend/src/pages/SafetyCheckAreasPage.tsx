              ...
              <>
                <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                  {visibleAreas.map((area) => (
                    <Card key={area.id} interactive padded={false}
                      ...
                      >
                        ...
                        <div
                          className="mt-5 flex items-center justify-between border-t border-line pt-4 text-xs text-text-muted">
                          <span>최근 점검</span>
                ...
                <div
                  className="mt-4 flex flex-col items-center justify-between gap-3 border-t border-line px-5 py-3 sm:flex-row">

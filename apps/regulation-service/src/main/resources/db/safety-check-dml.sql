-- Safety checklist UI development data. Run manually after schema.sql when sample data is needed.
...
INSERT IGNORE INTO safety_inspections
    ...
    (1, 2, 2, 18, 3, 'DRAFT', '부적합 항목 조치 완료 후 다시 확인',
     '2026-08-04 09:00:00.000000', '2026-08-04 11:20:00.000000', NULL),
    (2, 2, 2, 15, 3, 'COMPLETED', '안내 표지 위치를 조정하고 최종 확인함',
